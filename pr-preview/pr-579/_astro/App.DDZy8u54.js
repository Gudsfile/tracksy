...
from group_sizes
`;function Zr(e){let t=y(e);return Xr.replaceAll("${table}",_).replaceAll("${year_condition}",t)}function Qr(e){return e>50?{classification:`Obsessive`,emoji:`🔥`}:e<10?{classification:`Variated`,emoji:`🔀`}:{classification:`Moderate`,emoji:`🔁`}}var $r=({data:e,isLoading:n})=>{let{total_repeat_sequences:r=0,max_consecutive:i=0,most_repeated_track:o=``,avg_repeat_length:s=0}=e??{},{classification:c,emoji:l}=Qr(r);return(0,H.jsx)(t,{title:`Replay Style`,emoji:`🔁`,isLoading:n,question:`Do I replay the same tracks over and over?`,children:e?.total_repeat_sequences?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(S,{label:c,sublabel:`${r} repeated sequences`,emoji:l}),(0,H.jsxs)(`div`,{className:`space-y-3`,children:[(0,H.jsxs)(`div`,{className:`bg-gray-200 dark:bg-slate-700/50 p-3 rounded-lg`,children:[(0,H.jsx)(`div`,{className:`text-xs text-gray-600 dark:text-gray-400 mb-1`,children:`Repeat Record`}),(0,H.jsxs)(`div`,{className:`font-medium text-brand-purple dark:text-brand-purple line-clamp-1`,children:[`"`,o,`"`]}),(0,H.jsxs)(`div`,{className:`text-sm font-bold mt-1`,children:[i,` times in a row 🎸`]})]}),(0,H.jsx)(`ul`,{className:`mb-1`,role:`list`,children:(0,H.jsxs)(`li`,{className:`flex justify-between items-center text-sm`,role:`listitem`,children:[(0,H.jsx)(`span`,{className:`text-gray-600 dark:text-gray-400`,children:`Repeat average`}),(0,H.jsxs)(`span`,{className:`font-bold`,children:[s.toFixed(1),` times`]})]})})]})]}):(0,H.jsx)(a,{})})};function ei({year:e}){let{data:t,isLoading:n}=b({query:Zr(e),year:e});return(0,H.jsx)($r,{data:t,isLoading:n})}var ti=`select
...
limit 1
`;function zi(e){let t=y(e);return Ri.replaceAll("${table}",_).replaceAll("${year_condition}",t)}function Bi(e){return new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`})}var Vi=({data:e,isLoading:n,year:r})=>(0,H.jsx)(t,{title:`On a Roll`,emoji:`🔥`,isLoading:n,question:r===void 0?`What's my longest listening run ever?`:`What's my longest listening run in ${r}?`,children:e?.streak_days?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(S,{label:String(e.streak_days),sublabel:`days in a row`}),(0,H.jsxs)(u,{children:[Bi(e.start_date),` –`,` `,Bi(e.end_date)]})]}):(0,H.jsx)(a,{})});function Hi({year:e}){let{data:t,isLoading:n}=b({query:zi(e),year:e});return(0,H.jsx)(Vi,{data:t,isLoading:n,year:e})}var Ui=`select
...
limit 1
`;function Xi(e){let t=y(e);return Yi.replaceAll("${table}",_).replaceAll("${year_condition}",t)}function Zi(e){return new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{month:`long`,day:`numeric`,year:`numeric`})}var Qi=({data:e,isLoading:n,year:r})=>(0,H.jsx)(t,{title:`Eclectic Day`,emoji:`🎨`,isLoading:n,question:r===void 0?`My most diverse listening day ever?`:`My most diverse listening day in ${r}?`,children:e?.artist_count?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(S,{label:String(e.artist_count),sublabel:`different artists`}),(0,H.jsx)(u,{children:Zi(e.stream_date)})]}):(0,H.jsx)(a,{})});function $i({year:e}){let{data:t,isLoading:n}=b({query:Xi(e),year:e});return(0,H.jsx)(Qi,{data:t,isLoading:n,year:e})}var ea=`select
...
order by count_streams desc
limit 5
`;function xa(e){let t=y(e);return ba.replaceAll("${table}",_).replaceAll("${year_condition}",t)}var Sa=(0,B.memo)(function({data:e,isLoading:n}){let r=(e??[]).map(e=>({primary:e.track_name,secondary:e.artist_name,score:e.count_streams.toLocaleString()}));return(0,H.jsx)(t,{title:`Top Tracks`,emoji:`🎵`,isLoading:n,children:e?.length?(0,H.jsx)(C,{items:r}):(0,H.jsx)(a,{})})});function Ca({year:e}){let{data:t,isLoading:n}=x({query:xa(e),year:e});return(0,H.jsx)(Sa,{data:t,isLoading:n})}var wa=(0,B.memo)(xr),Ta=(0,B.memo)(Tr),Ea=(0,B.memo)(Ar),Da=(0,B.memo)(Pr),Oa=(0,B.memo)(Rr),ka=(0,B.memo)(Gr),Aa=(0,B.memo)(Yr),ja=(0,B.memo)(ei),Ma=(0,B.memo)(Ci),Na=(0,B.memo)(Di),Pa=(0,B.memo)(Mi),Fa=(0,B.memo)(Li),Ia=(0,B.memo)(Hi),La=(0,B.memo)(Ji),Ra=(0,B.memo)($i),za=(0,B.memo)(ra),Ba=(0,B.memo)(oa),Va=(0,B.memo)(da),Ha=(0,B.memo)(ha),Ua=(0,B.memo)(ya),Wa=(0,B.memo)(Ca);function Ga(){let[e,t]=(0,B.useState)(void 0),[r,i]=(0,B.useState)(),a=ot(e,250),o=(0,B.useCallback)(async()=>{try{let e=await c(it);i(e[0]||void 0)}catch{}},[]);return(0,B.useEffect)(()=>{o()},[o]),(0,B.useEffect)(()=>(window.addEventListener(n,o),()=>window.removeEventListener(n,o)),[o]),(0,B.useEffect)(()=>{r&&t(new Date(Number(r.max_datetime)).getFullYear())},[r]),(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:`mt-4 mb-6`,children:(0,H.jsx)(Ma,{})}),r&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(at,{value:e,min:new Date(Number(r.min_datetime)).getFullYear(),max:new Date(Number(r.max_datetime)).getFullYear(),onChange:t}),(0,H.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4`,children:[(0,H.jsx)(Wa,{year:a}),(0,H.jsx)(Ha,{year:a}),(0,H.jsx)(Ua,{year:a}),(0,H.jsx)(`div`,{className:`md:col-span-3`,children:(0,H.jsx)(za,{year:a})}),(0,H.jsx)(wa,{year:a}),(0,H.jsx)(Ta,{year:a}),(0,H.jsx)(Ea,{year:a}),(0,H.jsx)(`div`,{className:`md:col-span-2`,children:(0,H.jsx)(Oa,{year:a})}),(0,H.jsx)(Da,{year:a}),(0,H.jsx)(ka,{year:a}),(0,H.jsx)(`div`,{className:`row-span-2`,children:(0,H.jsx)(Pa,{year:a})}),(0,H.jsx)(Aa,{year:a}),(0,H.jsx)(`div`,{className:`row-span-2`,children:(0,H.jsx)(Va,{year:a})}),(0,H.jsx)(ja,{year:a}),(0,H.jsx)(`div`,{className:`row-span-3 md:col-span-2`,children:(0,H.jsx)(Ba,{year:a})}),(0,H.jsx)(Na,{year:a}),(0,H.jsx)(Fa,{year:a}),(0,H.jsx)(Ia,{year:a}),(0,H.jsx)(La,{year:a}),(0,H.jsx)(Ra,{year:a})]})]})]})}function Ka(){return(0,H.jsxs)(`svg`,{width:`50`,height:`50`,viewBox:`0 0 50 50`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,H.jsx)(`defs`,{children:(0,H.jsxs)(`linearGradient`,{id:`spinner-gradient`,x1:`0%`,y1:`0%`,x2:`100%`,y2:`0%`,children:[(0,H.jsx)(`stop`,{offset:`0%`,style:{stopColor:`#3498db`,stopOpacity:1}}),(0,H.jsx)(`stop`,{offset:`100%`,style:{stopColor:`#e74c3c`,stopOpacity:1}})]})}),(0,H.jsx)(`circle`,{cx:`25`,cy:`25`,r:`20`,fill:`none`,strokeWidth:`5`,stroke:`url(#spinner-gradient)`,strokeLinecap:`round`,children:(0,H.jsx)(`animateTransform`,{attributeName:`transform`,type:`rotate`,dur:`1s`,from:`0 25 25`,to:`360 25 25`,repeatCount:`indefinite`})})]})}var qa=(0,B.lazy)(()=>dt(()=>import(`./LabView.BTkLZHhZ.js`).then(e=>({default:e.LabView})),__vite__mapDeps([0,1,2,3,4,5,6,7,8]))),Ja=(0,B.lazy)(()=>dt(()=>import(`./ChatView.BNnAgMoD.js`).then(e=>({default:e.ChatView})),__vite__mapDeps([9,1,2,3,4,5,6,10,11,12,8,13]))),Ya=(0,B.lazy)(()=>dt(()=>import(`./QueryView.KJexxIV4.js`).then(e=>({default:e.QueryView})),__vite__mapDeps([14,1,3]))),$=[{id:`simple`,label:`✨ Simple`,tooltip:`Curated and guided overview of your listening data`},{id:`lab`,label:`🔬 Lab`,tooltip:`Experimental insights and advanced visualizations`},{id:`chat`,label:`💬 Chat (beta)`,tooltip:`Conversational exploration using a built-in LLM`},{id:`query`,label:`⌨️ Query`,tooltip:`Direct SQL-based exploration of the dataset`}];function Xa(){let[e,t]=(0,B.useState)(`simple`),[n,r]=(0,B.useState)(0),i=(0,B.useRef)(void 0),a=$.findIndex(t=>t.id===e),o=(0,B.useCallback)(e=>{i.current=e,t(`query`),r(e=>e+1)},[]);return(0,H.jsx)(ct.Provider,{value:o,children:(0,H.jsxs)(`div`,{className:`py-8 animate-slide-up`,children:[(0,H.jsxs)(`div`,{className:`relative mb-8 bg-gray-100 dark:bg-slate-800/50 backdrop-blur-md p-1.5 rounded-2xl shadow-lg border border-gray-300/60 dark:border-slate-700/50 max-w-xl mx-auto`,children:[(0,H.jsx)(`div`,{className:`absolute top-1.5 left-1.5 h-[calc(100%-0.75rem)] bg-gradient-brand rounded-xl shadow-glow transition-transform duration-300 ease-out`,style:{width:`calc(${(100/$.length).toFixed(4)}% - 0.25rem)`,transform:`translateX(calc(${a} * (100% + 0.125rem)))`}}),(0,H.jsx)(`div`,{className:`relative flex gap-1`,role:`tablist`,children:$.map(n=>(0,H.jsx)(`button`,{role:`tab`,"aria-selected":e===n.id,title:n.tooltip,onClick:()=>t(n.id),className:`relative z-10 flex-1 px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-300 ${e===n.id?`text-white`:`text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200`}`,children:n.label},n.id))})]}),(0,H.jsx)(`div`,{children:(0,H.jsx)(B.Suspense,{fallback:(0,H.jsx)(`div`,{className:`flex justify-center py-12`,children:(0,H.jsx)(Ka,{})}),children:e===`simple`?(0,H.jsx)(Ga,{}):e===`lab`?(0,H.jsx)(qa,{}):e===`query`?(0,H.jsx)(Ya,{initialQuery:i.current,onQueryConsumed:()=>{i.current=void 0}},n):(0,H.jsx)(Ja,{})})})]})})}var Za=8e3;function Qa({message:e,onDismiss:t}){let[n,r]=(0,B.useState)(!1),i=(0,B.useRef)(Za),a=(0,B.useRef)(Date.now());return(0,B.useEffect)(()=>{i.current=Za,a.current=Date.now()},[e]),(0,B.useEffect)(()=>{if(n){i.current=Math.max(0,i.current-(Date.now()-a.current));return}a.current=Date.now();let e=setTimeout(t,i.current);return()=>clearTimeout(e)},[n,e,t]),(0,H.jsxs)(`div`,{role:`alert`,"aria-live":`assertive`,"aria-atomic":`true`,onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),className:`fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-lg bg-rose-700 px-5 py-3 text-white shadow-lg`,children:[(0,H.jsx)(`span`,{className:`select-text`,children:e}),(0,H.jsx)(`button`,{type:`button`,onClick:t,className:`ml-1 rounded p-0.5 hover:bg-rose-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white`,"aria-label":`Dismiss error`,children:`✕`})]})}function $a({initialDb:e=null,initialIsDataDropped:t=!1,initialIsDataReady:n=!1}){let[r,i]=(0,B.useState)(e),[a,o]=(0,B.useState)(t),[s,c]=(0,B.useState)(n),[l,u]=(0,B.useState)(null),[d,f]=(0,B.useState)(null),p=(0,B.useCallback)(()=>u(null),[]),{isDemoReady:ee,handleDemoButtonClick:te,demoJsonUrl:ne,demoProgress:re}=_r(),m=d??re;(0,B.useEffect)(()=>{(async()=>{let e=await g();i(e)})()},[]);async function ie(e){if(e){c(!1),o(!0),f(null);try{await fr(e,(e,t)=>f({stage:e,percent:t})),c(!0)}catch(e){console.error(`Failed to upload files:`,e),c(!1),o(!1),u(or(e))}finally{f(null)}}}return r?(0,H.jsxs)(H.Fragment,{children:[(!a||s)&&!m&&(0,H.jsxs)(`div`,{className:`flex flex-col md:flex-row gap-4 items-stretch`,children:[(0,H.jsx)(`div`,{className:`flex-grow transition-all duration-300`,children:(0,H.jsx)(cr,{handleValidatedFiles:ie,onFail:e=>u(or(e))})}),(0,H.jsxs)(`div`,{className:`flex flex-col justify-center gap-4`,children:[(0,H.jsx)(hr,{label:`?`,tooltip:`How do I get my data?`}),ne&&(0,H.jsx)(mr,{label:`↓`,tooltip:`Load demo data`,handleClick:te})]})]}),m&&(0,H.jsx)(pr,{stage:m.stage,percent:m.percent}),(s||ee)&&(0,H.jsx)(Xa,{}),l&&(0,H.jsx)(Qa,{message:l,onDismiss:p})]}):(0,H.jsx)(H.Fragment,{children:(0,H.jsx)(`p`,{className:`dark:text-white`,children:`Initializing the database engine (DuckDB-WASM)...`})})}var eo={system:{icon:`M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z`,label:e=>`System (${e})`},dark:{icon:`M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z`,label:()=>`Dark`},light:{icon:`M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z`,label:()=>`Light`}},to=({path:e})=>(0,H.jsx)(`svg`,{className:`w-5 h-5`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,children:(0,H.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:e})}),no=e=>i[(i.indexOf(e)+1)%i.length];function ro(){let{theme:e,setTheme:t,effectiveTheme:n}=(0,B.useContext)(d),r=eo[e],i=r.label(n);return(0,H.jsx)(`button`,{onClick:()=>t(no(e)),className:`flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 dark:bg-slate-800/50 backdrop-blur-md p-1.5 rounded-2xl shadow-lg border border-gray-300/60 dark:border-slate-700/50 max-w-md mx-auto text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors duration-200`,"aria-label":`Current theme: ${i}. Click to change theme.`,title:i,children:(0,H.jsx)(to,{path:r.icon})})}function io(){return(0,H.jsx)(r,{children:(0,H.jsxs)(`div`,{className:`min-h-screen flex flex-col bg-gray-50 dark:bg-slate-950 relative transition-colors duration-300`,children:[(0,H.jsx)(`div`,{className:`absolute top-6 right-6 z-50`,children:(0,H.jsx)(ro,{})}),(0,H.jsx)(`div`,{className:`flex flex-1 items-center justify-center px-4 relative z-10`,children:(0,H.jsxs)(`div`,{className:`max-w-4xl w-full mx-auto py-12`,children:[(0,H.jsx)(`h1`,{className:`text-4xl md:text-5xl font-bold text-center mb-8 animate-fade-in`,children:(0,H.jsx)(`a`,{href:`/tracksy/pr-preview/pr-579`,className:`bg-gradient-brand bg-clip-text text-transparent hover:opacity-80 transition-opacity drop-shadow-sm`,children:`Tracksy`})}),(0,H.jsx)($a,{})]})}),(0,H.jsx)(`footer`,{className:`relative z-10 pb-6 text-center text-sm text-gray-400 dark:text-slate-500`,children:(0,H.jsx)(`a`,{href:`https://github.com/Gudsfile/tracksy`,target:`_blank`,rel:`noopener noreferrer`,className:`hover:text-gray-600 dark:hover:text-slate-300 transition-colors`,children:`Music stats made with ❤️ & 🔐 · View on GitHub`})})]})})}export{io as App};