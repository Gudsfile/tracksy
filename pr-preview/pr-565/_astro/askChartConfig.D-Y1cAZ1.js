import{r as e}from"./react.DJx7QJrC.js";import{t}from"./devBus.DRONl0Hn.js";import{n}from"./engine.DxSS63j_.js";function r(e){return typeof e==`number`&&Number.isFinite(e)}function i(e){if(typeof e!=`string`&&typeof e!=`number`)return!1;let t=new Date(e);return!Number.isNaN(t.getTime())}function a(e){if(!e||e.length===0)return`table`;let t=e[0],n=Object.keys(t);if(e.length===1&&n.length===1&&r(t[n[0]]))return`metric`;if(n.length===2){let[a,o]=n,s=typeof t[a]==`string`?a:typeof t[o]==`string`?o:void 0,c=r(t[a])?a:r(t[o])?o:void 0;if(s&&c)return i(t[s])&&e.length>6?`line`:e.length<=25?`list`:`bar`}return`table`}var o=e({askChartConfig:()=>f,inferConfig:()=>d}),s=`You are a chart type selector. Given a user question, column names with their types, and the row count, output a JSON chart config.
