import{n as e}from"./react-dom.673hvCjg.js";import{a as t,c as n,i as r,l as i,n as a,o,r as s,s as c,t as l}from"./InsightCard.DZ85Q9lC.js";import{r as u}from"./getDB.COZ4IwAq.js";import{i as d,n as f,o as p}from"./constants.th95jnuK.js";var m=`with artist_streams as (
    select
...
order by
    ...
    stream_count desc,
    platform desc
`;function me(e){let t=o(e);return pe.replaceAll("${table}",p).replaceAll("${year_condition}",t)}var he=({data:e,isLoading:n})=>(0,h.jsx)(t,{title:`Your Sound Machine`,emoji:`📱`,isLoading:n,question:`Which platform do I use the most for listening?`,children:e?.length?e.length===1?(0,h.jsxs)(`p`,{className:`text-sm text-gray-400 dark:text-gray-500 italic text-center py-6`,children:[`All streams are on `,e[0].platform]}):(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(b,{label:e[0].platform,sublabel:`${e[0].stream_count.toLocaleString()} streams`,labelColor:`text-brand-purple`}),(0,h.jsx)(`ul`,{className:`space-y-3`,role:`list`,children:e.map(e=>(0,h.jsx)(`li`,{role:`listitem`,children:(0,h.jsx)(_,{label:e.platform,value:`${e.pct.toFixed(1)}%`,valueColor:`text-gray-600 dark:text-gray-400`,pct:e.pct,barColor:`bg-brand-purple`})},e.platform))})]}):(0,h.jsx)(r,{})});function ge({year:e}){let{data:t,isLoading:n}=i({query:me(e),year:e});return(0,h.jsx)(he,{data:t,isLoading:n})}var _e=`with
daily_stats as (
    select
...
limit 1
`;function Ce(e){let t=o(e);return Se.replaceAll("${table}",p).replaceAll("${year_condition}",t)}function W(e){return new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`})}var we=({data:e,isLoading:n,year:i})=>(0,h.jsx)(t,{title:`On a Roll`,emoji:`🔥`,isLoading:n,question:i===void 0?`What's my longest listening run ever?`:`What's my longest listening run in ${i}?`,children:e?.streak_days?(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(b,{label:String(e.streak_days),sublabel:`days in a row`}),(0,h.jsxs)(l,{children:[W(e.start_date),` –`,` `,W(e.end_date)]})]}):(0,h.jsx)(r,{})});function Te({year:e}){let{data:t,isLoading:r}=n({query:Ce(e),year:e});return(0,h.jsx)(we,{data:t,isLoading:r,year:e})}var Ee=`select
    stream_date::varchar as stream_date,
    stream_count::double as stream_count
from \${table}
where \${year_condition}
order by stream_date
`;function De(e){let t=o(e,`year(stream_date)`);return Ee.replaceAll("${table}",f).replaceAll("${year_condition}",t)}function Oe(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function ke(e,t){let n=new Map(e.map(e=>[e.stream_date,e.stream_count])),r=new Date(t,0,1).getDay(),i=[],a=new Date(t,0,1),o=0;for(;a.getFullYear()===t;){let e=Oe(a);i.push({date:e,week:Math.floor((o+r)/7),dayOfWeek:a.getDay(),stream_count:n.get(e)??0}),a.setDate(a.getDate()+1),o++}return i}var G=24,Ae=3,je=[``,`Mon`,``,`Wed`,``,`Fri`,``];function Me(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t,n-1,r).toLocaleDateString(void 0,{month:`short`,day:`numeric`})}var K=({data:e,year:n,isLoading:i})=>{let[o,s]=(0,E.useState)(null);if(n===void 0)return(0,h.jsx)(t,{title:`Listening activity`,emoji:`🗓️`,children:(0,h.jsx)(`p`,{className:`text-sm text-gray-400 dark:text-gray-500 italic text-center py-6`,children:`Select a year to view the calendar`})});if(!e)return(0,h.jsx)(t,{title:`Listening activity`,emoji:`🗓️`,isLoading:i,children:(0,h.jsx)(r,{})});let c=ke(e,n),l=Math.max(1,...c.map(e=>e.stream_count)),u=c.length>0?c[c.length-1].week+1:53,d=c.reduce((e,t)=>{let n=e.get(t.week)??[];return n.push(t),e.set(t.week,n),e},new Map),f=Array.from({length:u},(e,t)=>{let n=Array(7).fill(null);return d.get(t)?.forEach(e=>{n[e.dayOfWeek]=e}),n}),p=(e,t)=>{let n=e.currentTarget.getBoundingClientRect();s({cell:t,x:n.left+n.width/2,y:n.top})},m=G+u*13;return(0,h.jsxs)(t,{title:`Listening activity`,emoji:`🗓️`,isLoading:i,children:[e&&(0,h.jsx)(`div`,{className:`overflow-x-auto`,children:(0,h.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`${G}px repeat(${u}, 1fr)`,gridTemplateRows:`repeat(7, auto)`,gap:`${Ae}px`,minWidth:`${m}px`},onMouseLeave:()=>s(null),children:[je.map((e,t)=>(0,h.jsx)(`div`,{style:{gridColumn:1,gridRow:t+1},className:`text-[8px] flex items-center justify-end pr-1 text-gray-400 dark:text-gray-600`,children:e},`label-${t}`)),f.flatMap((e,t)=>e.map((e,n)=>e===null?(0,h.jsx)(`div`,{style:{gridColumn:t+2,gridRow:n+1,aspectRatio:`1`}},`${t}-${n}`):(0,h.jsx)(`div`,{style:{gridColumn:t+2,gridRow:n+1,aspectRatio:`1`,...e.stream_count>0&&{backgroundColor:`rgba(124, 58, 237, ${Math.max(.15,e.stream_count/l)})`}},className:`rounded-xs ${e.stream_count===0?`bg-gray-100 dark:bg-slate-700/50`:``}`,onMouseEnter:t=>p(t,e)},`${t}-${n}`)))]})}),o&&(0,h.jsx)(a,{x:o.x,y:o.y,title:Me(o.cell.date),rows:[`${o.cell.stream_count} streams`]})]})};function Ne({year:e}){let{data:t,isLoading:n}=i({query:De(e),year:e});return(0,h.jsx)(K,{data:t,year:e,isLoading:n})}function Pe({year:e}){return e===void 0?(0,h.jsx)(K,{data:void 0,year:void 0}):(0,h.jsx)(Ne,{year:e})}var Fe=`select
...
order by play_hour
`;function Ie(e){let t=o(e);return Fe.replaceAll("${table}",p).replaceAll("${year_condition}",t)}var Le=[`🕛`,`🕐`,`🕑`,`🕒`,`🕓`,`🕔`,`🕕`,`🕖`,`🕗`,`🕘`,`🕙`,`🕚`];function Re(e){return Le[e%12]}var q=150,J=150,Y=110,X=4,ze=new Set([0,3,6,9,12,15,18,21]);function Be(e,t,n,r){let i=e/24*2*Math.PI-Math.PI/2,a=(e+1)/24*2*Math.PI-Math.PI/2,o=n+t*Math.cos(i),s=r+t*Math.sin(i),c=n+t*Math.cos(a),l=r+t*Math.sin(a);return`M ${n} ${r} L ${o} ${s} A ${t} ${t} 0 ${+(a-i>Math.PI)} 1 ${c} ${l} Z`}function Ve(e,t,n,r){let i=(e+.5)/24*2*Math.PI-Math.PI/2;return{x:n+t*Math.cos(i),y:r+t*Math.sin(i)}}var He=({data:e,maxHourlyCount:n,isLoading:i})=>{let[o,c]=(0,E.useState)(null),l=n??(e?Math.max(...e.map(e=>e.count_streams),X):1),u=e&&e.length>0?e.reduce((e,t)=>t.count_streams>e.count_streams?t:e):void 0,d=u?.play_hour??-1;return(0,h.jsxs)(t,{title:`Around the Clock`,emoji:u?Re(u.play_hour):`🕐`,isLoading:i,question:`When do you listen to music?`,className:`h-full w-full`,children:[e?(0,h.jsxs)(h.Fragment,{children:[u&&(0,h.jsx)(b,{label:`${String(u.play_hour).padStart(2,`0`)}h`,sublabel:`${u.count_streams.toLocaleString()} streams`,labelColor:`text-teal-600`}),(0,h.jsxs)(`svg`,{viewBox:`0 0 300 300`,className:`w-full h-auto`,onMouseLeave:()=>c(null),children:[[.25,.5,.75,1].map(e=>(0,h.jsx)(`circle`,{cx:q,cy:J,r:Y*e,fill:`none`,className:`stroke-gray-200 dark:stroke-slate-600`,strokeWidth:.5},e)),e.map(e=>{let t=e.count_streams>0?Math.max(X,e.count_streams/l*Y):0;if(t===0)return null;let n=o?.hour===e.play_hour,r=e.play_hour===d;return(0,h.jsx)(`path`,{d:Be(e.play_hour,t,q,J),className:n?`fill-teal-300 stroke-white dark:stroke-slate-900`:r?`fill-teal-600 stroke-white dark:stroke-slate-900`:`fill-teal-400 stroke-white dark:stroke-slate-900`,strokeWidth:.75,onMouseEnter:n=>{let r=n.currentTarget.closest(`svg`).getBoundingClientRect(),i=(e.play_hour+.5)/24*2*Math.PI-Math.PI/2,a=t/2,o=r.width,s=r.height;c({x:r.left+(q+a*Math.cos(i))*(o/300),y:r.top+(J+a*Math.sin(i))*(s/300),hour:e.play_hour,count:e.count_streams,ms:e.ms_played})}},e.play_hour)}),Array.from({length:24},(e,t)=>{let n=Ve(t,126,q,J);return ze.has(t)?(0,h.jsx)(`text`,{x:n.x,y:n.y,textAnchor:`middle`,dominantBaseline:`central`,fontSize:9,fontWeight:500,className:`fill-gray-900 dark:fill-gray-100`,children:String(t).padStart(2,`0`)},t):(0,h.jsx)(`circle`,{cx:n.x,cy:n.y,r:1.5,className:`fill-gray-400 dark:fill-gray-500`},t)})]})]}):(0,h.jsx)(r,{}),o&&(0,h.jsx)(a,{x:o.x,y:o.y,title:`${String(o.hour).padStart(2,`0`)}h`,rows:[`${o.count} streams`,s(o.ms)]})]})};function Ue({year:e,maxHourlyCount:t}){let{data:n,isLoading:r}=i({query:Ie(e),year:e});return(0,h.jsx)(He,{data:n,maxHourlyCount:t,isLoading:r})}var We=`select
...
limit 5
`;function Xe(e){let t=o(e);return Ye.replaceAll("${table}",p).replaceAll("${year_condition}",t)}var Z=[`🥇`,`🥈`,`🥉`,`4️⃣`,`5️⃣`],Q=({items:e})=>(0,h.jsx)(`ul`,{className:`space-y-2`,role:`list`,children:e.map((e,t)=>(0,h.jsxs)(`li`,{className:`flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors`,role:`listitem`,children:[(0,h.jsx)(`span`,{className:`text-xl flex-shrink-0`,children:Z[t]}),(0,h.jsxs)(`div`,{className:`flex-1 min-w-0`,title:e.primary,children:[(0,h.jsx)(`div`,{className:`font-medium truncate`,children:e.primary}),e.secondary&&(0,h.jsx)(`div`,{className:`text-xs text-gray-500 dark:text-gray-400 truncate`,children:e.secondary})]}),(0,h.jsx)(`div`,{className:`text-sm font-bold text-brand-purple dark:text-brand-purple flex-shrink-0`,children:e.score})]},`${e.primary}-${e.secondary??t}`))}),Ze=(0,E.memo)(function({data:e,isLoading:n}){let i=(e??[]).map(e=>({primary:e.artist_name,secondary:s(e.ms_played).split(` `)[0],score:e.count_streams.toLocaleString()}));return(0,h.jsx)(t,{title:`Top Artists`,emoji:`🎤`,isLoading:n,children:e?.length?(0,h.jsx)(Q,{items:i}):(0,h.jsx)(r,{})})});function Qe({year:e}){let{data:t,isLoading:n}=i({query:Xe(e),year:e});return(0,h.jsx)(Ze,{data:t,isLoading:n})}var $e=`select
    album_name,
    artist_name,
    count(*)::double as count_streams,
    sum(ms_played)::double as ms_played
...
order by count_streams desc
limit 5
`;function et(e){let t=o(e);return $e.replaceAll("${table}",p).replaceAll("${year_condition}",t)}var tt=(0,E.memo)(function({data:e,isLoading:n}){let i=(e??[]).map(e=>({primary:e.album_name,secondary:e.artist_name,score:e.count_streams.toLocaleString()}));return(0,h.jsx)(t,{title:`Top Albums`,emoji:`💿`,isLoading:n,children:e?.length?(0,h.jsx)(Q,{items:i}):(0,h.jsx)(r,{})})});function nt({year:e}){let{data:t,isLoading:n}=i({query:et(e),year:e});return(0,h.jsx)(tt,{data:t,isLoading:n})}var rt=`select
    track_name,
    artist_name,
    count(*)::double as count_streams,
    sum(ms_played)::double as ms_played
...
order by count_streams desc
limit 5
`;function it(e){let t=o(e);return rt.replaceAll("${table}",p).replaceAll("${year_condition}",t)}var at=(0,E.memo)(function({data:e,isLoading:n}){let i=(e??[]).map(e=>({primary:e.track_name,secondary:e.artist_name,score:e.count_streams.toLocaleString()}));return(0,h.jsx)(t,{title:`Top Tracks`,emoji:`🎵`,isLoading:n,children:e?.length?(0,h.jsx)(Q,{items:i}):(0,h.jsx)(r,{})})});function ot({year:e}){let{data:t,isLoading:n}=i({query:it(e),year:e});return(0,h.jsx)(at,{data:t,isLoading:n})}var st=(function(){let e=typeof document<`u`&&document.createElement(`link`).relList;return e&&e.supports&&e.supports(`modulepreload`)?`modulepreload`:`preload`})(),ct=function(e){return`/tracksy/pr-preview/pr-536/`+e},$={},lt=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=ct(t,n),t=s(t),t in $)return;$[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:st,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};export{ie as _,Je as a,Te as c,fe as d,B as f,le as g,C as h,Qe as i,xe as l,O as m,ot as n,Ue as o,F as p,nt as r,Pe as s,lt as t,ge as u,b as v,y};