 ...
 * @param {Function} [params.onSuccess] - Optional callback function to be called when the file upload is successful.
...
export function useFileUpload({
     ...
     * 2. If there is only one file and it is a ZIP archive, it extracts the files from the archive and inserts them into the database.
     * 3. If there are multiple files or the file is not a ZIP archive, it directly inserts the files into the database.
     * 4. Calls the `onSuccess` callback if the operation is successful.
