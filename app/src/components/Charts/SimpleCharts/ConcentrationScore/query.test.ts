...
const testData: TestStreamEntry[] = [
    ...
    { ts: testDate, artist_name: 'artist3' },
    { ts: testDate, artist_name: 'artist3' },
    { ts: testDate, artist_name: 'artist4' },
    { ts: testDate, artist_name: 'artist4' },
    { ts: testDate, artist_name: 'artist4' },
    { ts: testDate, artist_name: 'artist4' },
    { ts: testDate, artist_name: 'artist5' },
    { ts: testDate, artist_name: 'artist5' },
    { ts: testDate, artist_name: 'artist5' },
    { ts: testDate, artist_name: 'artist5' },
    // Top 10
    { ts: testDate, artist_name: 'artist6' },
    { ts: testDate, artist_name: 'artist6' },
    { ts: testDate, artist_name: 'artist7' },
    { ts: testDate, artist_name: 'artist7' },
    { ts: testDate, artist_name: 'artist8' },
    { ts: testDate, artist_name: 'artist8' },
    { ts: testDate, artist_name: 'artist9' },
    { ts: testDate, artist_name: 'artist9' },
    { ts: testDate, artist_name: 'artist10' },
    { ts: testDate, artist_name: 'artist10' },
    // Top 20
    { ts: testDate, artist_name: 'artist11' },
    { ts: testDate, artist_name: 'artist12' },
    { ts: testDate, artist_name: 'artist13' },
    { ts: testDate, artist_name: 'artist14' },
    { ts: testDate, artist_name: 'artist15' },
    { ts: testDate, artist_name: 'artist16' },
    { ts: testDate, artist_name: 'artist17' },
    { ts: testDate, artist_name: 'artist18' },
    { ts: testDate, artist_name: 'artist19' },
    { ts: testDate, artist_name: 'artist20' },
    { ts: testDate, artist_name: 'artist21' },
    { ts: testDate, artist_name: 'artist22' },
    { ts: testDate, artist_name: 'artist23' },
    { ts: testDate, artist_name: 'artist24' },
    { ts: anotherYear, artist_name: 'artist24' },
]
